...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const formSubmitUrl = 'https://formsubmit.co/shounakmandal22@gmail.com';
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div data-aos="fade-up" data-aos-delay="300" className="relative group">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  disabled={isSubmitting}
                  className="w-full resize-none p-4 pl-12 bg-white/10 rounded-xl border border-white/20 placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-[#6366f1]/30 transition-all duration-300 h-[9.9rem] disabled:opacity-50"
                  required
                />
              </div>
