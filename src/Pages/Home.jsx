...
const WORDS = ["Full Stack Developer","AI & ML Enthusiast","Cybersecurity Learner", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind, C++"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Shounak02" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/shounakmandal/" },
  { icon: Instagram, link: "https://www.instagram.com/shounak02/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Building innovative, functional, and user-friendly web solutions powered by modern technologies and AI.
                </p>
