...
const TechBadge = ({ tech }) => {
  ...
  return (
    <div className="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-xl border border-blue-500/10 hover:border-blue-500/30 transition-all duration-300">
...
const ProjectStats = ({ project }) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-[#0a0a1a] rounded-xl relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900/20 to-purple-900/20 opacity-50 blur-2xl" />
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-blue-500/20 hover:scale-105 hover:border-blue-500/50 hover:shadow-lg transition-all">
      ...
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-purple-500/20 hover:scale-105 hover:border-purple-500/50 hover:shadow-lg transition-all">
...
// Component for rendering PNG or SVG
    ...
    const fetchProject = async () => {
      ...
      if (!error && data) {
        setProject({
          ...
          Github: data.Github || "https://github.com/Shounak02",
        });
      } else {
        console.error(error);
      }
    ...
    <div className="min-h-screen bg-[#030014] px-[2%] sm:px-0 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
        ...
        <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
          <button
            onClick={() => navigate(-1)}
            className="group inline-flex items-center space-x-1.5 md:space-x-2 px-3 md:px-5 py-2 md:py-2.5 bg-white/5 backdrop-blur-xl rounded-xl text-white/90 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-300 text-sm md:text-base"
          >
          ...
          <div className="space-y-6 md:space-y-10 animate-slideInLeft">
            ...
            <div className="flex flex-wrap gap-3 md:gap-4">
              ...
              <a
                ...
                className="group relative inline-flex items-center space-x-1.5 md:space-x-2 px-4 md:px-8 py-2.5 md:py-4 bg-gradient-to-r from-purple-600/10 to-pink-600/10 hover:from-purple-600/20 hover:to-pink-600/20 text-purple-300 rounded-xl border border-purple-500/20 hover:border-purple-500/40 backdrop-blur-xl transition-all duration-300 text-sm md:text-base"
              >
